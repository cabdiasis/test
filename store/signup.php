...
<body>
  ...
  <section class="service_section layout_padding ">
    <div class="container">
      <h2 class="custom_heading">Sign Up Form</h2>
      ...
      <div class="form-style-5">
        <form method="post">
          ...
          <input type="text" name="location" placeholder="Enter Business Location" required>
          <label>Email:</label>
          <input type="email" name="email" placeholder="Enter Business Email" required>
          <label>Phone Number:</label>
          <input type="text" name="number" placeholder="Enter Business Phone Number" required>
